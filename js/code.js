...
function loadContacts(contactToFlip) {
	...
	var url = '/LAMPAPI/ReadContacts.php';
	...
	try {
		...
		document.getElementById('contact-ul').innerHTML = err.message;
	}
